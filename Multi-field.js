...
(function () {
    ...
    ACS.TouchUI.Widget = new Class({
        ...
        isRichTextField: function ($field) {
            ...
            return true;
            //alert(!_.isEmpty($field) && $field.prop("type") === "hidden" && !$field.hasClass("coral-RichText-isRichTextFlag") && $field.parent().hasClass("richtext-container"));
        ...
        setRichTextField: function ($field, value) {
            ...
            if(value){
            $field.val(value);
            $field.parent().find(".coral-RichText-editable.coral-RichText").append(value);
            $field.parent().find("input.coral-Form-field").val(value);
            }
        },
